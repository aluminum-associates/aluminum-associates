    ...
    <nav className="navbar is-fixed-top">
      <div className="container">
        <div className="navbar-brand">
          ...
          <div id="burger" className="navbar-burger">
            <span></span>
            <span></span>
            <span></span>
          </div>
        ...
        <div id="nav-menu" className="navbar-menu">
          <div className="navbar-end">
            ...
            <Link to="/products" className="navbar-item" activeClassName="is-active">
              Products
            </Link>
            <Link to="/services" className="navbar-item" activeClassName="is-active">
              Services
            </Link>
